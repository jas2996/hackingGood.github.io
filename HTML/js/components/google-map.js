...
var GoogleMap = function() {
    ...
    var handleGoogleMaps = function() {
        function initialize() {
            ...
            var Toronto = new google.maps.LatLng(43.640, -79.379);
            ...
            coordInfoWindow.setContent(createInfoWindowContent(Toronto, map.getZoom()));
            coordInfoWindow.setPosition(Toronto);
